...
<?php
				...
				if (sizeof($digitoolPids) > 0) {
					$thumb_rep .= getDigitoolThumbnailLink($digitoolPids[0]);
				...
				*/ # libis_end
					...
					print "<td valign='bottom' align='center' width='100'><table cellpadding='0' cellspacing='0' width='100' height='100%' align='center' border='0'><tr align='center' border='0' valign='middle'><td align='center' border='0' valign='middle' style='text-align:center;'>".$thumb_rep;	// libis
					print "</td></tr><tr valign='bottom' align='center'><td nowrap='wrap' border='0' align='center' style='word-wrap: break-word; width: 150px; background-color:#eee;' border='1px solid #ccc;'>".$t_collection->get('ca_collections.preferred_labels')."<br/>".$t_collection->get('ca_collections.idno')."<br/>".$t_collection->get('ca_collections.preferred_labels');
